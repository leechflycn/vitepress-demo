      ...
      return function() {
        var e2 = { 37: function(e3, t3, n2) {
          ...
          t3.A = { components: { TkAvatar: f["default"], TkMetaInput: p["default"] }, directives: { Clickoutside: c["default"] }, props: { replyId: String, pid: String, config: Object }, data: function() {
            return { isSending: false, isPreviewing: false, isMetaValid: false, errorMessage: "", owo: null, comment: "", commentHtml: "", nick: "", mail: "", link: "", turnstileLoad: null, geeTestLoad: null, geeTestCaptchaObj: null, capLoad: null, iconMarkdown: a["default"], iconEmotion: u["default"], iconImage: s["default"] };
          }, computed: { captchaProvider: function() {
            return "undefined" != typeof this.config.CAPTCHA_PROVIDER ? this.config.CAPTCHA_PROVIDER : this.config.TURNSTILE_SITE_KEY ? "Turnstile" : this.config.GEETEST_CAPTCHA_ID ? "Geetest" : this.config.CAP_API_ENDPOINT ? "Cap" : "";
          }, showImage: function() {
            ...
            var e4 = this;
            "Cap" === this.captchaProvider && this.config.CAP_API_ENDPOINT && (window.Cap ? this.capLoad = Promise.resolve() : this.capLoad = new Promise(function(t4, n3) {
              var r3 = document.createElement("script");
              r3.src = "https://cdn.jsdmirror.com/npm/@cap.js/widget", r3.onload = t4, r3.onerror = n3, e4.$refs["cap-container"].appendChild(r3);
            }));
          }, getCapToken: function() {
            var e4 = this;
            return new Promise(function(t4, n3) {
              e4.capLoad.then(function() {
                var r3 = document.createElement("cap-widget");
                r3.setAttribute("id", "cap-widget"), r3.setAttribute("data-cap-api-endpoint", e4.config.CAP_API_ENDPOINT), e4.$refs["cap-container"].appendChild(r3);
                var i2 = function() {
                  r3 && r3.parentNode && r3.parentNode.removeChild(r3);
                };
                r3.solve().then(function(e5) {
                  i2(), e5.success ? t4(e5.token) : n3(new Error("Cap验证失败"));
                })["catch"](function(e5) {
                  i2(), n3(e5);
                });
              });
            ...
            return (0, o["default"])(i["default"].mark(function t4() {
              ...
              return i["default"].wrap(function(t5) {
                for (; ; ) switch (t5.prev = t5.next) {
                  ...
                  case 28:
                    if ("Cap" !== e4.captchaProvider || !e4.config.CAP_API_ENDPOINT) {
                      t5.next = 32;
                      break;
                    }
                    return t5.next = 31, e4.getCapToken();
                  case 31:
                    n3.capToken = t5.sent;
                  case 32:
                    return t5.next = 34, (0, d.call)(e4.$tcb, "COMMENT_SUBMIT", n3);
                  case 34:
                    if (!((o2 = t5.sent) && o2.result && o2.result.id)) {
                      t5.next = 42;
                      break;
                    }
                    e4.comment = "", e4.errorMessage = "", e4.$emit("load"), e4.saveDraft(), t5.next = 43;
                    break;
                  case 42:
                  ...
                  case 43:
                    ...
                    break;
                  case 45:
                    t5.prev = 45, t5.t9 = t5["catch"](1), d.logger.error("评论失败", t5.t9), e4.errorMessage = "".concat((0, d.t)("COMMENT_FAILED"), ": ").concat(t5.t9 && t5.t9.message);
                  case 49:
                    return t5.prev = 49, e4.isSending = false, t5.finish(49);
                  case 52:
                  case "end":
                    return t5.stop();
                }
              ...
              return i["default"].wrap(function(n4) {
                for (; ; ) switch (n4.prev = n4.next) {
                  ...
                  case 2:
                    ...
                    return n4.abrupt("return");
                  case 6:
                    return a2 = t4.getUserId(), s2 = "".concat(Date.now(), "-").concat(a2), u2 = r3.join("."), c2 = "image/gif" === e4.type, l2 = c2 ? u2 : u2 + ".webp", f2 = c2 ? o2 : "webp", t4.paste(t4.getImagePlaceholder(s2, f2)), p2 = t4.config.IMAGE_CDN, n4.next = 16, t4.compressImage(e4);
                  case 16:
            ...
            this.pid && this.$refs["tk-submit"].scrollIntoView({ behavior: "instant", block: "center" }), this.initDraft(), this.initOwo(), this.addEventListener(), this.onBgImgChange(), this.initTurnstile(), this.initGeeTest(), this.initCap();
          ...
          t3.Yp = t3.XX = void 0, t3.XX = function() {
            var e4 = this, t4 = e4._self._c;
            return t4("div", { staticClass: "tk-comments" }, [t4("tk-submit", { attrs: { config: e4.config }, on: { load: e4.initComments } }), e4._v(" "), t4("div", { directives: [{ name: "loading", rawName: "v-loading", value: e4.loading, expression: "loading" }], staticClass: "tk-comments-container" }, [t4("div", { staticClass: "tk-comments-title" }, [t4("span", { staticClass: "tk-comments-count", "class": { __hidden: !e4.comments.length } }, [t4("span", [e4._v(e4._s(e4.count))]), e4._v(" "), t4("span", [e4._v(e4._s(e4.t("COMMENTS_COUNT_SUFFIX")))])]), e4._v(" "), t4("span", { staticClass: "tk-comments-actions" }, [!e4.loading && e4.comments.length && "false" !== e4.config.SHOW_ORDER ? t4("span", { staticClass: "tk-comments-sort" }, [t4("button", { staticClass: "tk-sort-item", "class": { __active: "newest" === e4.currentSort }, attrs: { type: "button" }, on: { click: function(t5) {
        ...
        }, 1846: function(e3, t3, n2) {
          var r2 = n2(7317);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("16722b25", r2, true, {});
        }, 1903: function() {
        }, 1914: function(e3, t3, n2) {
          "use strict";
          n2.r(t3), n2.d(t3, { __esModule: function() {
            return i.B;
          }, "default": function() {
          ...
          var r2 = n2(1721), i = n2(4333), o = i.A, a = (n2(2630), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
                  ...
                  for (var k = m.pattern || m, w = r4.next, E = u2; w !== t5.tail && !(d2 && E >= d2.reach); E += w.value.length, w = w.next) {
                    ...
                    if (!(A instanceof o)) {
                      ...
                      if (_) {
                        ...
                        var x = C.index, S = C.index + C[0].length, D = E;
                        for (D += w.value.length; x >= D; ) D += (w = w.next).value.length;
                        if (E = D -= w.value.length, w.value instanceof o) continue;
                        for (var O = w; O !== t5.tail && (D < S || "string" == typeof O.value); O = O.next) I++, D += O.value.length;
                        I--, A = e5.slice(E, D), C.index -= E;
                      } else if (!(C = a(k, 0, A, v))) continue;
                      x = C.index;
                      var T = C[0], N = A.slice(0, x), M = A.slice(x + T.length), P = E + A.length;
                      d2 && P > d2.reach && (d2.reach = P);
                      var F = w.prev;
                      if (N && (F = c(t5, F, N), E += N.length), l(t5, F, I), w = c(t5, F, new o(f2, g ? i.tokenize(T, g) : T, y, T)), M && c(t5, w, M), I > 1) {
          ...
          var r2 = n2(3459), i = n2(147), o = i.A, a = (n2(8084), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
          ...
          "use strict";
          Object.defineProperty(t3, "__esModule", { value: true }), t3.version = void 0, t3.version = "1.7.7";
        ...
        }, 2630: function(e3, t3, n2) {
          var r2 = n2(6727);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("2f96e18e", r2, true, {});
          ...
          var i = r2(n2(9367)), o = n2(2566), a = n2(9250), s = n2(4325), u = n2(2007), c = n2(1235), l = n2(4522), d = n2(7036), f = n2(9676), p = n2(2424), h = function() {
          ...
          }, y = o.events.CloudbaseEventEmitter, b = o.adapters.RUNTIME, k = o.utils.printWarn, w = o.utils.throwError, E = o.utils.transformPhone, A = o.constants.ERRORS, C = o.constants.COMMUNITY_SITE_URL, I = o.helpers.catchErrorsDecorator, x = t3.eventBus = new y(), S = function() {
            function e4(e5) {
            ...
            function e4(e5) {
              ...
              t4 || w(A.INVALID_PARAMS, "envId is not defined"), this._cache = n3, this.user = new S({ cache: n3, request: r3 });
            }
          ...
          }, handleSpam: function(e4) {
            this.setComment({ isSpam: e4 });
          }, handleTop: function(e4) {
            this.setComment({ top: e4 });
          ...
          var r2 = n2(477);
          Object.defineProperty(t3, "B", { value: true }), t3.A = void 0;
          var i = r2(n2(479)), o = r2(n2(4964)), a = r2(n2(2889)), s = r2(n2(7945)), u = r2(n2(7111)), c = r2(n2(9985)), l = r2(n2(9097)), d = n2(8129), f = r2(n2(9671));
          ...
          }, v = o.adapters.useAdapters, _ = o.adapters.useDefaultAdapter, y = o.adapters.RUNTIME, b = o.constants.ERRORS, k = o.constants.COMMUNITY_SITE_URL, w = o.utils.printWarn, E = o.helpers.catchErrorsDecorator, A = { timeout: 15e3, persistence: "local" }, C = 6e5, I = {}, x = function() {
            function e4(e5) {
          ...
          var r2 = n2(477);
          Object.defineProperty(t3, "B", { value: true }), t3.A = void 0;
          var i = r2(n2(479)), o = r2(n2(4964)), a = r2(n2(504)), s = r2(n2(9966)), u = r2(n2(4478)), c = n2(8129), l = n2(1085), d = r2(n2(9629)), f = r2(n2(2107));
        ...
        }, 4591: function(e3, t3, n2) {
          var r2 = n2(7400);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("08630572", r2, true, {});
          ...
          t3.A = { data: function() {
            return { loading: true, settings: [{ name: (0, a.t)("ADMIN_CONFIG_CATEGORY_COMMON"), items: [{ key: "SITE_NAME", desc: (0, a.t)("ADMIN_CONFIG_ITEM_SITE_NAME"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "虹墨空间站"), value: "" }, { key: "SITE_URL", desc: (0, a.t)("ADMIN_CONFIG_ITEM_SITE_URL"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "https://www.imaegoo.com"), value: "" }, { key: "CORS_ALLOW_ORIGIN", desc: (0, a.t)("ADMIN_CONFIG_ITEM_CORS_ALLOW_ORIGIN"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "https://www.imaegoo.com"), value: "" }, { key: "BLOGGER_NICK", desc: (0, a.t)("ADMIN_CONFIG_ITEM_BLOGGER_NICK"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "iMaeGoo"), value: "" }, { key: "BLOGGER_EMAIL", desc: (0, a.t)("ADMIN_CONFIG_ITEM_BLOGGER_EMAIL"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "12345@qq.com"), value: "" }, { key: "COMMENT_PAGE_SIZE", desc: (0, a.t)("ADMIN_CONFIG_ITEM_COMMENT_PAGE_SIZE"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "8"), value: "" }, { key: "MASTER_TAG", desc: (0, a.t)("ADMIN_CONFIG_ITEM_MASTER_TAG"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "站长"), value: "" }, { key: "COMMENT_BG_IMG", desc: (0, a.t)("ADMIN_CONFIG_ITEM_COMMENT_BG_IMG"), ph: "", value: "" }, { key: "GRAVATAR_CDN", desc: (0, a.t)("ADMIN_CONFIG_ITEM_GRAVATAR_CDN"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "sdn.geekzu.org"), value: "" }, { key: "DEFAULT_GRAVATAR", desc: (0, a.t)("ADMIN_CONFIG_ITEM_DEFAULT_GRAVATAR"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "mp"), value: "" }, { key: "COMMENT_PLACEHOLDER", desc: (0, a.t)("ADMIN_CONFIG_ITEM_COMMENT_PLACEHOLDER"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE")), value: "" }, { key: "SHOW_ORDER", desc: (0, a.t)("ADMIN_CONFIG_ITEM_SHOW_ORDER"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "true"), value: "" }, { key: "SHOW_DISLIKE", desc: (0, a.t)("ADMIN_CONFIG_ITEM_SHOW_DISLIKE"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "true"), value: "" }, { key: "DISPLAYED_FIELDS", desc: (0, a.t)("ADMIN_CONFIG_ITEM_DISPLAYED_FIELDS"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "nick,mail,link"), value: "" }, { key: "REQUIRED_FIELDS", desc: (0, a.t)("ADMIN_CONFIG_ITEM_REQUIRED_FIELDS"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "nick,mail,link"), value: "" }, { key: "HIDE_ADMIN_CRYPT", desc: (0, a.t)("ADMIN_CONFIG_ITEM_HIDE_ADMIN_CRYPT"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "admin"), value: "" }, { key: "QQ_API_KEY", desc: (0, a.t)("ADMIN_CONFIG_ITEM_QQ_API_KEY"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "your_api_key"), value: "" }] }, { name: (0, a.t)("ADMIN_CONFIG_CATEGORY_PLUGIN"), items: [{ key: "IMAGE_CDN", desc: (0, a.t)("ADMIN_CONFIG_ITEM_IMAGE_CDN"), options: [{ value: "", label: (0, a.t)("ADMIN_CONFIG_IMAGE_CDN_NONE") }, { value: "qcloud", label: "qcloud" }, { value: "7bu", label: "7bu (https://7bu.top)" }, { value: "see", label: "see (https://s.ee)" }, { value: "lskypro", label: "lskypro" }, { value: "piclist", label: "piclist" }, { value: "easyimage", label: "easyimage" }, { value: "chevereto", label: "chevereto" }, { value: "s3", label: "S3 / R2 / MinIO" }], value: "" }, { key: "IMAGE_CDN_URL", desc: (0, a.t)("ADMIN_CONFIG_ITEM_IMAGE_CDN_URL"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "https://piclist.example.com"), value: "", showIf: function(e4) {
              return ["lskypro", "piclist", "easyimage"].includes(e4("IMAGE_CDN"));
              ...
              return e4("IMAGE_CDN") && "s3" !== e4("IMAGE_CDN");
              ...
              return "Geetest" === e4("CAPTCHA_PROVIDER");
            } }, { key: "CAP_API_ENDPOINT", desc: (0, a.t)("ADMIN_CONFIG_ITEM_CAP_API_ENDPOINT"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "https://cap.example.com/d9256640cb53/"), value: "", showIf: function(e4) {
              return "Cap" === e4("CAPTCHA_PROVIDER");
            } }, { key: "CAP_SECRET_KEY", desc: (0, a.t)("ADMIN_CONFIG_ITEM_CAP_SECRET_KEY"), ph: "".concat((0, a.t)("ADMIN_CONFIG_EXAMPLE"), "your_cap_secret_key"), value: "", secret: true, showIf: function(e4) {
              return "Cap" === e4("CAPTCHA_PROVIDER");
              ...
              return i["default"].wrap(function(t5) {
                for (; ; ) switch (t5.prev = t5.next) {
                  case 0:
                    ...
                    return n3.IMAGE_CDN !== void 0 && (n3.SHOW_IMAGE = n3.IMAGE_CDN ? "true" : "false"), a.logger.log("保存配置", n3), t5.next = 9, (0, a.call)(e4.$tcb, "SET_CONFIG", { config: n3 });
                  case 9:
          ...
          var r2 = n2(3052), i = n2(2566), o = n2(4283), a = n2(1706), s = n2(5315), u = n2(4319), c = function() {
          ...
          var k = t3.CloudbaseRequest = function() {
            ...
            return e4.prototype.post = function(e5) {
              ...
              return l(this, void 0, void 0, function() {
                var i2, o2, a2, s2, l2, f2, p2, h2, y2, b2, k2, w2, E, A, C, I, x, S, D, O, T, N, M, P, F, L;
                return d(this, function(d2) {
                  switch (d2.label) {
                    ...
                    case 3:
                      ...
                      return h2 = { headers: { "content-type": o2 } }, (null == n3 ? void 0 : n3.onUploadProgress) && (h2.onUploadProgress = n3.onUploadProgress), this.config.region && (h2.headers["X-TCB-Region"] = this.config.region), (y2 = this._localCache.getStore(i2)) && (h2.headers["X-TCB-Trace"] = y2), u.Platform.runtime !== v.WEB && (b2 = this.config, k2 = b2.appSign, w2 = b2.appSecret, E = Date.now(), A = w2.appAccessKey, C = w2.appAccessKeyId, I = g({ data: {}, timestamp: E, appAccessKeyId: C, appSign: k2 }, A), h2.headers["X-TCB-App-Source"] = "timestamp=" + E + ";appAccessKeyId=" + C + ";appSign=" + k2 + ";sign=" + I), x = t4.parse, S = t4.inQuery, D = t4.search, O = { env: this.config.env }, x && (O.parse = true), S && (O = c(c({}, S), O)), T = (0, r2.getEndPoint)(), N = T.BASE_URL, M = T.PROTOCOL, P = m(M, N, O), D && (P += D), [4, this.post(c({ url: P, data: f2 }, h2))];
                    case 4:
        ...
        }, 6509: function(e3, t3, n2) {
          var r2 = n2(8402);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("79ae887c", r2, true, {});
        }, 6530: function(e3) {
          "use strict";
          e3.exports = function(e4, t3) {
          ...
          }), T = /\B([A-Z])/g, N = x(function(e4) {
            return e4.replace(T, "-$1").toLowerCase();
          }), M = Function.prototype.bind ? function(e4, t4) {
            return e4.bind(t4);
          } : function(e4, t4) {
            function n3(n4) {
          ...
          var Ne = { notify: R, depend: R, addSub: R, removeSub: R }, Me = function() {
            function e4(t4) {
              var n3 = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], r3 = arguments.length > 2 && arguments[2] !== void 0 && arguments[2];
              if ((0, i["default"])(this, e4), this.value = t4, this.shallow = n3, this.mock = r3, this.dep = r3 ? Ne : new we(), this.vmCount = 0, X(t4, "__ob__", this), u(t4)) {
          ...
          function Pe(e4, t4, n3) {
            return e4 && I(e4, "__ob__") && e4.__ob__ instanceof Me ? e4.__ob__ : !Oe || !n3 && ce() || !u(e4) && !g(e4) || !Object.isExtensible(e4) || e4.__v_skip || qe(e4) || e4 instanceof ge ? void 0 : new Me(e4, t4, n3);
          }
          ...
          function Ye(e4, t4) {
            ...
            X(e4, n3, i2), X(i2, "__v_isReadonly", true), X(i2, "__v_raw", e4), qe(e4) && X(i2, He, true), (t4 || Be(e4)) && X(i2, "__v_isShallow", true);
          ...
          function ot(e4, t4) {
            ...
            if (qe(e4) ? (n3 = function() {
              ...
              return e4.map(function(e5) {
                return qe(e5) ? e5.value : Ge(e5) ? (e5.__ob__.dep.depend(), Cn(e5)) : p(e5) ? f2(e5, et) : void 0;
              });
            }) : n3 = p(e4) ? t4 ? function() {
              return f2(e4, et);
            } : function() {
          ...
          function kt(e4, t4, n3, r3, i2) {
            ...
            return i2 && r3 && !W.keyCodes[t4] ? bt(i2, r3) : o2 ? bt(o2, e4) : r3 ? N(r3) !== t4 : void 0 === e4;
          }
          ...
          function Tt(e4) {
            e4._o = At, e4._n = k, e4._s = y, e4._l = vt, e4._t = _t, e4._q = U, e4._i = G, e4._m = Et, e4._f = yt, e4._k = kt, e4._b = wt, e4._v = _e, e4._e = ve, e4._u = St, e4._g = xt, e4._d = Dt, e4._p = Ot;
          }
          function Nt(e4, t4) {
            ...
            for (var c2 in n3) n3[c2].every(Mt) && delete n3[c2];
            return n3;
          }
          function Mt(e4) {
          ...
          function jt(e4) {
            ...
            }, emit: M(e4.$emit, e4), expose: function(t4) {
          ...
          function Vt(e4, t4, n3, r3, i2, o2) {
            return (u(n3) || f(n3)) && (i2 = r3, r3 = n3, n3 = void 0), d(o2) && (i2 = 2), function(e5, t5, n4, r4, i3) {
              return l(n4) && l(n4.__ob__) ? ve() : (l(n4) && l(n4.is) && (t5 = n4.is), t5 ? (u(r4) && p(r4[0]) && ((n4 = n4 || {}).scopedSlots = { "default": r4[0] }, r4.length = 0), 2 === i3 ? r4 = ht(r4) : 1 === i3 && (r4 = function(e6) {
                ...
                return e6;
              }(r4)), "string" == typeof t5 ? (a2 = e5.$vnode && e5.$vnode.ns || W.getTagNamespace(t5), o3 = W.isReservedTag(t5) ? new ge(W.parsePlatformTagName(t5), n4, r4, void 0, void 0, e5) : n4 && n4.pre || !l(s2 = mr(e5.$options, "components", t5)) ? new ge(t5, n4, r4, void 0, void 0, e5) : or(s2, n4, e5, r4, t5)) : o3 = or(t5, n4, e5, r4), u(o3) ? o3 : l(o3) ? (l(a2) && Wt(o3, a2), l(n4) && function(e6) {
          ...
          var ln = cn("beforeMount"), dn = cn("mounted"), fn = cn("beforeUpdate"), pn = cn("updated"), hn = cn("beforeDestroy"), mn = cn("destroyed"), gn = cn("activated"), vn = cn("deactivated"), _n = cn("serverPrefetch"), yn = cn("renderTracked"), bn = cn("renderTriggered"), kn = cn("errorCaptured"), wn = "2.7.16", En = Object.freeze({ __proto__: null, version: wn, defineComponent: function(e4) {
            ...
            return Ve(e4, true);
          }, isRef: qe, toRef: Ke, toRefs: function(e4) {
          ...
          function Mn(e4, t4, n3) {
            xn = e4, dt(t4, n3 || {}, On, Tn, Nn, e4), xn = void 0;
          }
          var Pn = null;
          function Fn(e4) {
            var t4 = Pn;
          ...
          function $n(e4, t4, n3) {
            ...
            if (a2) for (var u2 = 0, c2 = a2.length; u2 < c2; u2++) Xt(a2[u2], e4, n3 || null, e4, s2);
            e4._hasHookEvent && e4.$emit("hook:" + t4), r3 && (me(i2), o2 && o2.on()), Ce();
          }
          var Un = [], Gn = [], Bn = {}, zn = false, Hn = false, qn = 0, Vn = 0, Wn = Date.now;
          if (J && !ee) {
          ...
          function Yn() {
            var e4, t4;
            for (Vn = Wn(), Hn = true, Un.sort(Xn), qn = 0; qn < Un.length; qn++) (e4 = Un[qn]).before && e4.before(), t4 = e4.id, Bn[t4] = null, e4.run();
            var n3 = Gn.slice(), r3 = Un.slice();
            qn = Un.length = Gn.length = 0, Bn = {}, zn = Hn = false, function(e5) {
          ...
          function Qn(e4) {
            var t4 = e4.id;
            if (null == Bn[t4] && (e4 !== we.target || !e4.noRecurse)) {
              if (Bn[t4] = true, Hn) {
          ...
          function Zn(e4, t4, n3, r3, i2) {
            ...
            this.data = e4, this.props = t4, this.children = n3, this.parent = r3, this.listeners = e4.on || s, this.injections = Jn(c2.inject, r3), this.slots = function() {
              return a2.$slots || Ft(r3, e4.scopedSlots, a2.$slots = Nt(n3, r3)), a2.$slots;
          ...
          var rr = { init: function(e4, t4) {
            ...
            !function(e5, t5, n4, r3, i2) {
              ...
              if (e5._listenersProxy && $t(e5._listenersProxy, n4, f2 || s, e5, "$listeners"), e5.$listeners = e5.$options._parentListeners = n4, Mn(e5, n4, f2), t5 && e5.$options.props) {
                Te(false);
              ...
              c2 && (e5.$slots = Nt(i2, r3.context), e5.$forceUpdate());
          ...
          function Er(e4) {
            ...
            if (t4.props && function(e5, t5) {
              ...
              for (var a2 in o2 || Te(false), t5) i2.push(a2), Fe(r3, a2, gr(a2, t5, n4, e5), void 0, true), a2 in e5 || wr(e5, "_props", a2);
              Te(true);
              ...
              for (var n4 in e5.$options.props, t5) e5[n4] = "function" != typeof t5[n4] ? R : M(t5[n4], e5);
              ...
              for (var i2 = n4.length; i2--; ) {
                var o2 = n4[i2];
                r3 && I(r3, o2) || K(o2) || wr(e5, "_data", o2);
              }
              var a2 = Pe(t5);
              a2 && a2.vmCount++;
            }(e4);
          ...
          !function(e4) {
            e4.prototype._init = function(e5) {
              ...
              t4._uid = Dr++, t4._isVue = true, t4.__v_skip = true, t4._scope = new at(true), t4._scope.parent = void 0, t4._scope._vm = true, e5 && e5._isComponent ? function(e6, t5) {
                ...
                e6.$slots = Nt(t5._renderChildren, r3), e6.$scopedSlots = n3 ? Ft(e6.$parent, n3.data.scopedSlots, e6.$slots) : s, e6._c = function(t6, n4, r4, i3) {
          ...
          var Lr = [String, RegExp, Array], Rr = { KeepAlive: { name: "keep-alive", abstract: true, props: { include: Lr, exclude: Lr, max: [String, Number] }, methods: { cacheVNode: function() {
            ...
            if (n3) {
              ...
              e4[r3] = { name: Nr(a2), tag: i2, componentInstance: o2 }, t4.push(r3), this.max && t4.length > parseInt(this.max) && Fr(e4, t4[0], t4, this._vnode), this.vnodeToCache = null;
            }
          } }, created: function() {
            ...
            if (n3) {
              var r3 = Nr(n3), i2 = this.include, o2 = this.exclude;
              if (i2 && (!r3 || !Mr(i2, r3)) || o2 && r3 && Mr(o2, r3)) return t4;
          ...
          function oi(e4, t4, n3) {
            ...
            r3 && I(r3, t4) && (qe(r3[t4]) ? r3[t4].value = n3 : r3[t4] = n3);
          }
          ...
          function _i(e4, t4, n3, r3) {
            r3 || e4.tagName.indexOf("-") > -1 ? yi(e4, t4, n3) : Br(t4) ? Vr(n3) ? e4.removeAttribute(t4) : (n3 = "allowfullscreen" === t4 && "EMBED" === e4.tagName ? "true" : t4, e4.setAttribute(t4, n3)) : Ur(t4) ? e4.setAttribute(t4, function(e5, t5) {
              return Vr(t5) || "false" === t5 ? "false" : "contenteditable" === e5 && Gr(t5) ? t5 : "true";
            }(t4, n3)) : Hr(t4) ? Vr(n3) ? e4.removeAttributeNS(zr, qr(t4)) : e4.setAttributeNS(zr, t4, n3) : yi(e4, t4, n3);
          }
          function yi(e4, t4, n3) {
            Vr(n3) ? e4.removeAttribute(t4) : (!ee || te || "TEXTAREA" !== e4.tagName || "placeholder" !== t4 || "" === n3 || e4.__ieph || (e4.addEventListener("input", function r3(t5) {
          ...
          var wi, Ei = { create: ki, update: ki }, Ai = "__r", Ci = "__c";
          ...
          function Oi(e4, t4) {
            if (!c(e4.data.on) || !c(t4.data.on)) {
              ...
              }(n3), dt(n3, r3, Si, Di, Ii, t4.context), wi = void 0;
            }
          }
          var Ti, Ni = { create: Oi, update: Oi, destroy: function(e4) {
            return Oi(e4, ai);
          } };
          function Mi(e4, t4) {
          ...
          var Fi = { create: Mi, update: Mi }, Li = x(function(e4) {
            var t4 = {}, n3 = /:(.+)/;
          ...
          var $i, Ui = /^--/, Gi = /\s*!important$/, Bi = function(e4, t4, n3) {
            ...
            else if (Gi.test(n3)) e4.style.setProperty(N(t4), n3.replace(Gi, ""), "important");
            else {
              var r3 = Hi(t4);
          ...
          function mo(e4, t4) {
            ...
            if (!c(r3) && !l(n3._enterCb) && 1 === n3.nodeType) {
              for (var i2 = r3.css, o2 = r3.type, a2 = r3.enterClass, s2 = r3.enterToClass, u2 = r3.enterActiveClass, d2 = r3.appearClass, f2 = r3.appearToClass, m2 = r3.appearActiveClass, g2 = r3.beforeEnter, v2 = r3.enter, _2 = r3.afterEnter, y2 = r3.enterCancelled, b2 = r3.beforeAppear, w2 = r3.appear, E2 = r3.afterAppear, A2 = r3.appearCancelled, C2 = r3.duration, I2 = Pn, x2 = Pn.$vnode; x2 && x2.parent; ) I2 = x2.context, x2 = x2.parent;
              var S2 = !I2._isMounted || !e4.isRootInsert;
              if (!S2 || w2 || "" === w2) {
                var D2 = S2 && d2 ? d2 : a2, O2 = S2 && m2 ? m2 : u2, T2 = S2 && f2 ? f2 : s2, N2 = S2 && b2 || g2, M2 = S2 && p(w2) ? w2 : v2, P2 = S2 && E2 || _2, F2 = S2 && A2 || y2, L2 = k(h(C2) ? C2.enter : C2), R2 = false !== i2 && !te, j2 = _o(M2), $2 = n3._enterCb = B(function() {
                ...
                e4.data.show || ft(e4, "insert", function() {
                  ...
                  r4 && r4.tag === e4.tag && r4.elm._leaveCb && r4.elm._leaveCb(), M2 && M2(n3, $2);
                }), N2 && N2(n3), R2 && (so(n3, D2), so(n3, O2), ao(function() {
                  uo(n3, D2), $2.cancelled || (so(n3, T2), j2 || (vo(L2) ? setTimeout($2, L2) : co(n3, o2, $2)));
                })), e4.data.show && (t4 && t4(), M2 && M2(n3, $2)), R2 || j2 || $2();
              }
            }
          }
          function go(e4, t4) {
            ...
            if (!l(n3._leaveCb)) {
              var i2 = r3.css, o2 = r3.type, a2 = r3.leaveClass, s2 = r3.leaveToClass, u2 = r3.leaveActiveClass, d2 = r3.beforeLeave, f2 = r3.leave, p2 = r3.afterLeave, m2 = r3.leaveCancelled, g2 = r3.delayLeave, v2 = r3.duration, _2 = false !== i2 && !te, y2 = _o(f2), b2 = k(h(v2) ? v2.leave : v2), w2 = n3._leaveCb = B(function() {
                n3.parentNode && n3.parentNode._pending && (n3.parentNode._pending[e4.key] = null), _2 && (uo(n3, s2), uo(n3, u2)), w2.cancelled ? (_2 && uo(n3, a2), m2 && m2(n3)) : (t4(), p2 && p2(n3)), n3._leaveCb = null;
              });
              g2 ? g2(E2) : E2();
            }
            function E2() {
          ...
          var bo = function(e4) {
              ...
              if (e5 !== t5) {
                ...
                if (d(e5.isAsyncPlaceholder)) l(t5.asyncFactory.resolved) ? S2(e5.elm, t5, n4) : t5.isAsyncPlaceholder = true;
                  ...
                  c(t5.text) ? l(m3) && l(v3) ? m3 !== v3 && function(e6, t6, n5, r4, i4) {
                    for (var a4, u3, d2, f3 = 0, p4 = 0, h4 = t6.length - 1, m4 = t6[0], g3 = t6[h4], v4 = n5.length - 1, _3 = n5[0], b3 = n5[v4], w2 = !i4; f3 <= h4 && p4 <= v4; ) c(m4) ? m4 = t6[++f3] : c(g3) ? g3 = t6[--h4] : ui(m4, _3) ? (C2(m4, _3, r4, n5, p4), m4 = t6[++f3], _3 = n5[++p4]) : ui(g3, b3) ? (C2(g3, b3, r4, n5, v4), g3 = t6[--h4], b3 = n5[--v4]) : ui(m4, b3) ? (C2(m4, b3, r4, n5, v4), w2 && o2.insertBefore(e6, m4.elm, o2.nextSibling(g3.elm)), m4 = t6[++f3], b3 = n5[--v4]) : ui(g3, _3) ? (C2(g3, _3, r4, n5, p4), w2 && o2.insertBefore(e6, g3.elm, m4.elm), g3 = t6[--h4], _3 = n5[++p4]) : (c(a4) && (a4 = ci(t6, f3, h4)), c(u3 = l(_3.key) ? a4[_3.key] : A2(_3, t6, f3, h4)) ? s2(_3, r4, e6, m4.elm, false, n5, p4) : ui(d2 = t6[u3], _3) ? (C2(d2, _3, r4, n5, p4), t6[u3] = void 0, w2 && o2.insertBefore(e6, d2.elm, m4.elm)) : s2(_3, r4, e6, m4.elm, false, n5, p4), _3 = n5[++p4]);
            ...
            var x2 = w("attrs,class,staticClass,staticStyle,key");
                  ...
                  if (!p3 && ui(e5, t5)) C2(e5, t5, f2, null, null, i3);
                    ...
                    if (s2(t5, f2, h3._leaveCb ? null : m3, o2.nextSibling(h3)), l(t5.parent)) for (var v3 = t5.parent, _3 = g2(t5); v3; ) {
                      ...
                      if (v3.elm = t5.elm, _3) {
                        ...
                        if (E3.merged) for (var A3 = E3.fns.slice(1), x3 = 0; x3 < A3.length; x3++) A3[x3]();
                      } else ii(v3);
                      v3 = v3.parent;
                    }
          ...
          }({ nodeOps: ni, modules: [bi, Ei, Ni, Fi, Vi, J ? { create: yo, activate: yo, remove: function(e4, t4) {
          ...
          var ko = { inserted: function(e4, t4, n3, r3) {
            ...
            }) : wo(e4, t4, n3.context), e4._vOptions = [].map.call(e4.options, Co)) : ("textarea" === n3.tag || ti(e4.type)) && (e4._vModifiers = t4.modifiers, t4.modifiers.lazy || (e4.addEventListener("compositionstart", Io), e4.addEventListener("compositionend", xo), e4.addEventListener("change", xo), te && (e4.vmodel = true)));
          ...
          } }, To = { model: ko, show: Oo }, No = { name: String, appear: Boolean, css: Boolean, mode: String, type: String, enterClass: String, leaveClass: String, enterToClass: String, leaveToClass: String, enterActiveClass: String, leaveActiveClass: String, appearClass: String, appearActiveClass: String, appearToClass: String, duration: [Number, String, Object] };
          function Mo(e4) {
            var t4 = e4 && e4.componentOptions;
            return t4 && t4.Ctor.options.abstract ? Mo(qt(t4.children)) : e4;
          }
          function Po(e4) {
          ...
          var Lo = function(e4) {
            ...
            return "show" === e4.name;
          }, jo = { name: "transition", props: No, abstract: true, render: function(e4) {
            ...
            if (n3 && (n3 = n3.filter(Lo)).length) {
              ...
              var s2 = (o2.data || (o2.data = {})).transition = Po(this), u2 = this._vnode, c2 = Mo(u2);
          ...
          var r2 = n2(3525), i = n2(3397), o = i.A, a = (n2(8390), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
        }, 6727: function(e3, t3, n2) {
          "use strict";
          n2.r(t3);
          var r2 = n2(5346), i = n2.n(r2), o = n2(9067), a = n2.n(o)()(i());
          ...
          var r2 = n2(2043), i = n2(4868), o = i.A, a = (n2(1846), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
          ...
          function i() {
            ...
            function p(e4, t5, n4, r3) {
              var i2 = t5 && t5.prototype instanceof b ? t5 : b, o2 = Object.create(i2.prototype), a2 = new M(r3 || []);
            ...
            return k.prototype = w, s(I, "constructor", { value: w, configurable: true }), s(w, "constructor", { value: k, configurable: true }), k.displayName = f(w, d, "GeneratorFunction"), n3.isGeneratorFunction = function(e4) {
              var t5 = "function" == typeof e4 && e4.constructor;
              return !!t5 && (t5 === k || "GeneratorFunction" === (t5.displayName || t5.name));
            }, n3.mark = function(e4) {
              return Object.setPrototypeOf ? Object.setPrototypeOf(e4, w) : (e4.__proto__ = w, f(e4, d, "GeneratorFunction")), e4.prototype = Object.create(I), e4;
            ...
            }, n3.values = P, M.prototype = { constructor: M, reset: function(e4) {
              if (this.prev = 0, this.next = 0, this.sent = this._sent = t4, this.done = false, this.delegate = null, this.method = "next", this.arg = t4, this.tryEntries.forEach(N), !e4) for (var n4 in this) "t" === n4.charAt(0) && a.call(this, n4) && !isNaN(+n4.slice(1)) && (this[n4] = t4);
            }, stop: function() {
              this.done = true;
              ...
              for (var t5 = this.tryEntries.length - 1; t5 >= 0; --t5) {
                ...
                if (n4.finallyLoc === e4) return this.complete(n4.completion, n4.afterLoc), N(n4), y;
              }
            }, "catch": function(e4) {
              for (var t5 = this.tryEntries.length - 1; t5 >= 0; --t5) {
                var n4 = this.tryEntries[t5];
        ...
        }, 8084: function(e3, t3, n2) {
          var r2 = n2(6245);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("f6771314", r2, true, {});
          ...
          t3.isNotSet = function(e4) {
            ...
            try {
              for (r3.s(); !(n3 = r3.n()).done; ) {
                var i2 = n3.value;
                i2.setAttribute("target", "_blank"), i2.setAttribute("rel", "noopener noreferrer nofollow ugc");
              }
            } catch (o2) {
              r3.e(o2);
            } finally {
          ...
          var r2 = n2(7696), i = n2(4238), o = i.A, a = (n2(6509), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
        }, 8390: function(e3, t3, n2) {
          var r2 = n2(323);
          r2.__esModule && (r2 = r2["default"]), "string" == typeof r2 && (r2 = [[e3.id, r2, ""]]), r2.locals && (e3.exports = r2.locals), (0, n2(5083).A)("c2fef9b0", r2, true, {});
        }, 8402: function(e3, t3, n2) {
          "use strict";
          n2.r(t3);
          var r2 = n2(5346), i = n2.n(r2), o = n2(9067), a = n2.n(o)()(i());
          ...
          var r2 = n2(477);
          Object.defineProperty(t3, "B", { value: true }), t3.A = void 0;
          var i = r2(n2(1914)), o = r2(n2(1452)), a = r2(n2(8375));
          ...
          t3.Yp = t3.XX = void 0, t3.XX = function() {
            var e4 = this, t4 = e4._self._c;
            return t4("div", { ref: "tk-comment", staticClass: "tk-comment", "class": { "tk-master": e4.comment.master }, attrs: { id: e4.comment.id } }, [t4("tk-avatar", { attrs: { config: e4.config, nick: e4.comment.nick, avatar: e4.comment.avatar, "mail-md5": e4.comment.mailMd5, link: e4.convertedLink } }), e4._v(" "), t4("div", { staticClass: "tk-main" }, [t4("div", { staticClass: "tk-row" }, [t4("div", { staticClass: "tk-meta" }, [e4.convertedLink ? e4._e() : t4("strong", { staticClass: "tk-nick" }, [e4._v(e4._s(e4.comment.nick))]), e4._v(" "), e4.convertedLink ? t4("a", { staticClass: "tk-nick tk-nick-link", attrs: { href: e4.convertedLink, target: "_blank", rel: "noopener noreferrer nofollow ugc" } }, [t4("strong", [e4._v(e4._s(e4.comment.nick))])]) : e4._e(), e4._v(" "), e4.comment.master ? t4("span", { staticClass: "tk-tag tk-tag-green" }, [e4._v(e4._s(e4.config.MASTER_TAG || e4.t("COMMENT_MASTER_TAG")))]) : e4._e(), e4._v(" "), e4.comment.top ? t4("span", { staticClass: "tk-tag tk-tag-red" }, [e4._v(e4._s(e4.t("COMMENT_TOP_TAG")))]) : e4._e(), e4._v(" "), e4.comment.isSpam ? t4("span", { staticClass: "tk-tag tk-tag-yellow" }, [e4._v(e4._s(e4.t("COMMENT_REVIEWING_TAG")))]) : e4._e(), e4._v(" "), t4("small", { staticClass: "tk-time" }, [t4("time", { attrs: { datetime: e4.jsonTimestamp, title: e4.localeTime } }, [e4._v(e4._s(e4.displayCreated))])]), e4._v(" "), e4.isLogin ? t4("small", { staticClass: "tk-actions" }, [e4.comment.isSpam ? t4("button", { on: { click: function(t5) {
              return e4.handleSpam(false);
            } } }, [e4._v(e4._s(e4.t("ADMIN_COMMENT_SHOW")))]) : e4._e(), e4._v(" "), e4.comment.isSpam ? e4._e() : t4("button", { on: { click: function(t5) {
              return e4.handleSpam(true);
            } } }, [e4._v(e4._s(e4.t("ADMIN_COMMENT_HIDE")))]), e4._v(" "), !e4.comment.rid && e4.comment.top ? t4("button", { on: { click: function(t5) {
              return e4.handleTop(false);
            } } }, [e4._v(e4._s(e4.t("ADMIN_COMMENT_UNTOP")))]) : e4._e(), e4._v(" "), e4.comment.rid || e4.comment.top ? e4._e() : t4("button", { on: { click: function(t5) {
              return e4.handleTop(true);
          ...
          var r2 = n2(9386), i = n2(3572), o = i.A, a = (n2(4591), (0, n2(4486).A)(o, r2.XX, r2.Yp, false, null, null, null).exports);
